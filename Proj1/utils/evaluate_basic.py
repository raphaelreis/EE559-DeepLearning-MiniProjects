...
def grid_search(net_type,training_function, drop_prob, hidden_layers, seeds, lrs,  mini_batch_size=100, optimizer = optim.Adam,
                 criterion = nn.CrossEntropyLoss(), n_epochs=40, 
