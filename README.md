...
### models 
This folder contain the network class  implemented in this project using the pytorch library and a class which  contains a dictionnary of this class (name and parameters).
...
*Nets.py
	*Class Nets : 
		...
		*Functions: Three function to perform grid search on the parameters of Net2c,LeNet_sharing and Lenet_sharing_aux
		To note : No grid search performed on the Google_Net network due to the high number of parameter and the computing power at diposal.
### Utils
